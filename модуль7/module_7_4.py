...
if score_1 > score_2 or score_1 == score_2 and team1_time > team2_time:
    challenger_result = 'Победа команды Мастера кода!'
elif score_1 < score_2 or score_1 == score_2 and team1_time < team2_time:
    challenger_result = 'Победа команды Волшебники Данных!'
else:
    challenger_result = 'Ничья!'
...
#Использование строк f
print(f'Результат битвы:', challenger_result)
